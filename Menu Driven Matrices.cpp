...
int get(int [][10], int, int);
int display(int [][10],int ,int);
...
int get(int a[][10],int size1,int size2)
{
	int i,j;
	for(i=0;i<size1;i++)
	{
...
int display(int y[][10],int size1,int size2)
{
	int i,j;
	for(i=0;i<size1;i++)
	{
